...
nnoremap <silent> <F5> :SyntasticCheck :SyntasticToggleMode
map <C-Space> ?
cnoremap  <Home>
cnoremap  <End>
...
set runtimepath=~/.vim_runtime/sources_non_forked/YouCompleteMe,~/.vim_runtime/sources_non_forked/ack.vim,~/.vim_runtime/sources_non_forked/bufexplorer,~/.vim_runtime/sources_non_forked/ctrlp.vim,~/.vim_runtime/sources_non_forked/delimitmate,~/.vim_runtime/sources_non_forked/goyo.vim,~/.vim_runtime/sources_non_forked/gruvbox,~/.vim_runtime/sources_non_forked/lightline.vim,~/.vim_runtime/sources_non_forked/mayansmoke,~/.vim_runtime/sources_non_forked/nerdtree,~/.vim_runtime/sources_non_forked/nginx-vim-syntax,~/.vim_runtime/sources_non_forked/open_file_under_cursor.vim,~/.vim_runtime/sources_non_forked/rust.vim,~/.vim_runtime/sources_non_forked/snipmate-snippets,~/.vim_runtime/sources_non_forked/syntastic,~/.vim_runtime/sources_non_forked/tabular,~/.vim_runtime/sources_non_forked/tlib,~/.vim_runtime/sources_non_forked/ultisnips,~/.vim_runtime/sources_non_forked/vim-addon-mw-utils,~/.vim_runtime/sources_non_forked/vim-bundle-mako,~/.vim_runtime/sources_non_forked/vim-coffee-script,~/.vim_runtime/sources_non_forked/vim-colors-solarized,~/.vim_runtime/sources_non_forked/vim-commentary,~/.vim_runtime/sources_non_forked/vim-easymotion,~/.vim_runtime/sources_non_forked/vim-expand-region,~/.vim_runtime/sources_non_forked/vim-flake8,~/.vim_runtime/sources_non_forked/vim-fugitive,~/.vim_runtime/sources_non_forked/vim-gitgutter,~/.vim_runtime/sources_non_forked/vim-go,~/.vim_runtime/sources_non_forked/vim-indent-object,~/.vim_runtime/sources_non_forked/vim-less,~/.vim_runtime/sources_non_forked/vim-markdown,~/.vim_runtime/sources_non_forked/vim-multiple-cursors,~/.vim_runtime/sources_non_forked/vim-pug,~/.vim_runtime/sources_non_forked/vim-pyte,~/.vim_runtime/sources_non_forked/vim-repeat,~/.vim_runtime/sources_non_forked/vim-snipmate,~/.vim_runtime/sources_non_forked/vim-snippets,~/.vim_runtime/sources_non_forked/vim-surround,~/.vim_runtime/sources_non_forked/vim-yankstack,~/.vim_runtime/sources_non_forked/vim-zenroom2,~/.vim_runtime/sources_non_forked/ycm_build,~/.vim_runtime/sources_forked/mru,~/.vim_runtime/sources_forked/peaksea,~/.vim_runtime/sources_forked/set_tabline,~/.vim_runtime/sources_forked/vim-irblack-forked,~/.vim_runtime/sources_forked/vim-peepopen,~/.vim,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim_runtime,~/.vim_runtime/sources_non_forked/vim-snipmate/after,~/.vim_runtime/sources_non_forked/vim-less/after,~/.vim_runtime/sources_non_forked/vim-coffee-script/after,~/.vim_runtime/sources_non_forked/ultisnips/after,~/.vim_runtime/sources_non_forked/tabular/after,~/.vim_runtime/sources_non_forked/rust.vim/after
set scrolloff=5
set shiftwidth=4
...
silent only
cd ~/Workspace/fy_project/code/data-investigation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 plots.py
badd +0 ~/Workspace/fy_project/code/data-creation/stage2.py
badd +0 ~/Workspace/fy_project/code/data-creation/churn.py
badd +0 ~/Workspace/fy_project/code/data-creation/stage1.py
badd +0 ../churn-prediction/logistic_regression.py
argglobal
silent! argdel *
argadd .
edit plots.py
...
setlocal statusline=%{lightline#link()}%#LightlineLeft_active_0#%(\ %{LightlineMode()}\ %)%{LightlineMode()!=#\"\"&&((&paste))?\"|\":\"\"}%(\ %{&paste?\"PASTE\":\"\"}\ %)%#LightlineLeft_active_0_1#%#LightlineLeft_active_1#%(\ %{LightlineFugitive()}\ %)%{LightlineFugitive()!=#\"\"&&(LightlineFilename()!=#\"\")?\"|\":\"\"}%(\ %{LightlineFilename()}\ %)%#LightlineLeft_active_1_2#%#LightlineLeft_active_2#%(\ %{CtrlPMark()}\ %)%#LightlineLeft_active_2_3#%#LightlineMiddle_active#%=%#LightlineRight_active_2_3#%#LightlineRight_active_2#%(\ %{LightlineFileformat()}\ %)%{LightlineFileformat()!=#\"\"&&(LightlineFileencoding()!=#\"\"||LightlineFiletype()!=#\"\")?\"|\":\"\"}%(\ %{LightlineFileencoding()}\ %)%{LightlineFileencoding()!=#\"\"&&(LightlineFiletype()!=#\"\")?\"|\":\"\"}%(\ %{LightlineFiletype()}\ %)%#LightlineRight_active_1_2#%#LightlineRight_active_1#%(\ %3p%%\ %)%#LightlineRight_active_0_1#%#LightlineRight_active_0#%(\ %3l:%-2v\ %)
...
silent! normal! zE
let s:l = 488 - ((35 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
488
normal! 05|
tabedit ~/Workspace/fy_project/code/data-creation/stage2.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
5
normal! 09|
tabedit ~/Workspace/fy_project/code/data-creation/churn.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 90 - ((34 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
normal! 08|
tabedit ../churn-prediction/logistic_regression.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
